...
$msgs  = array(
    ...
    'spotify_fail_deleted'        => '⚠ Wunsch gelöscht. Bitte den Song manuell aus der Spotify-Playlist entfernen (Spotify hat das automatische Entfernen im Feb. 2026 abgeschaltet).',
    'apple_fail_deleted'          => '⚠ Wunsch gelöscht. Bitte den Song manuell aus der Apple-Music-Playlist entfernen (Apple erlaubt kein automatisches Entfernen).',
    'spotify_fail_apple_fail_deleted' => '⚠ Wunsch gelöscht. Bitte den Song manuell aus beiden Playlists entfernen – beide Anbieter erlauben kein automatisches Entfernen.',
    ...
    <table class="wp-list-table widefat fixed striped mw-table">
        ...
        <?php else : foreach ( $rows as $w ) : ?>
            <tr class="<?php echo $w->ist_brautpaar ? 'mw-row--couple' : ''; ?>">
                ...
                <td>
                    <form method="post" style="display:inline" onsubmit="return confirm('Wunsch aus der Wunschliste löschen?\n\nHinweis: Spotify und Apple Music erlauben kein automatisches Entfernen aus Playlists. Du musst den Song manuell in den jeweiligen Apps löschen.')">
                        <?php wp_nonce_field( 'mw_nonce', 'mw_nonce_field' ); ?>
